...
\begin{enumerate}
    \item Pasirinkti du didelius pirminius skaičius $p$ ir $q$, kad bendras didižiausias daliklis tarp $p \cdot q, (p - 1), (q - 1)$ būtų lygus 1.
...
\par Turing viešą raktą, turinio šifravimui reikia sugalvoti atsitiktinį sveiką skaičių $r$. Tada galima galima turinį $M$ pagal formulę ().

\begin{equation}
    c = g^{m} \cdot r^{n} mod(n^{2})
\end{equation}

\par Turinio $c$ iššifravimui naudojama formulė ().
...
\begin{itemize}
    \item Atšiftuojant duomenis, turi būti validi salyga ().
    ...
    \item Norint užšifruoti neigiamą reikšmę $-m$, reikia laikytis lygybės ()
