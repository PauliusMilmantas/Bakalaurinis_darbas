...
\par Šis rangas nurodo, kurioje vietoje yra šis inicijuotas duomenų rinkinys sąraše, tarp visų galimų testavimo rinkinių kombinacijų. Pavyzdžiui, norima 
...
\par Tarkime, turime dviejų žmonių testavimo duomenų rinkinį. Pirmo žmogaus duomenys: [2, 60, 98, 25, 25], antro: [0, 90, 128, 27, 18]. Pirma yra skaičiuojami duomenų rangai. Vėliau pagal apskaičiuotus rangus, ieškoma atvirumo metrika. Visi skaičiavimai pateikti žemiau.
...
\par DMDK skaičiavimas pateiktas \eqref{eq:DMDK skaičiavimas 2} lygtyje.

\begin{equation}
DMDK = (\frac{3 + 2}{2} + \frac{6 + 1}{2} + \frac{4 + 0.1}{2})/3 \approx 2.683
\label{eq:DMDK skaičiavimas 2}
\end{equation}
