...
\par Turint suskaičiuotus galimus rinkinių rangus, bei entropijas, galima naudoti patobulinta skaičiavimo taktiką. Visi galimi duomenys yra surušiuojami pagal entropiją arba sudėtingumą. Sąrašo pradžioje yra elementas su mažiausia entropija. Jo atspėjimo tikimybė yra viena iš didžiausių. Dėl to gauname formulę \eqref{eq:Entropija}.
...
Gradientinio nusileidimo algoritmas & 2272.06 & 63.78\% & 0.051792 \\\cline{1-4}
...
\begin{itemize}
    \item Lyginant PyTorch neuroninį tinklą, paprastą gradientinio nusileidimo algoritmą ir Pallier homomorfiniu šifravimu grįstą modelį, jeigu visi minėti modeliai vykdant tyrimą konverguoja minimumo link, pats saugiausias modelis yra PyTorch neuroninis modelis. Mažiausiai duomenis saugantis yra paprastas gradientinis metodas. PyTorch DMDK funkcijos reikšmė - 87.419, Pallier homomorfiniu šifravimu grįsto modelio DMDK reikšmė - 0,1416, gradientinio nusileidimo algoritmo DMDK reikšmė - 0.051792.
    \item Naudojant Pallier homomorfiniu šifravimu grįstą modelį, egzistuoja koreliacija tarp modelio nuostolių funkcijos reikšmės ir DMDK rodiklio. Pagal Spearman metodą, koreliacija yra -0.8969792, stiprus statistinis ryšys, p-reikšmė 3.661e-08 < 0.05 - statistiškai reikšminga. Vidutiniškai, kuo nuostolių funkcijos reikšmė yra mažesnė, tuo DMDK rodiklis yra didesnis ir modelis yra saugesnis.
    ...
    \item Paprastas PyTorch neuroninis tinklas vienintelis iš minėtų modelių konverguoja minimumo link, su MNIST rašytinių skaičių nuotraukomis. Šiuo atveju, DMDK rodiklis vidutiniškai nukrenta iki 0.049 ir modelis tampa mažiau saugus, nei Pallier algoritmu grįstas modelis, kurio DMDK reikšmė - 0.1416.
    \item Didinant duomenų triukšmą, didėja DMDK reikšmė ir modelis tampa saugesnis, tačiau sumažėja modelio tikslumas. Spearman koreliacija yra 0.6978022, vidutiniškai statistiškai reikšminga, p-reikšmė 0.01033 < 0.05 - statistiškai reikšminga.
\end{itemize}
