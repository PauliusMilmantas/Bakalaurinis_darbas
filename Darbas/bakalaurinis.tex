...
\begin{itemize}
    ...
    \item Didinant duomenų triukšmą, didėja DMDK reikšmė ir modelis tampa saugesnis, tačiau sumažėja modelio tikslumas. Spearman korecialija yra 0.6978022, vidutiniškai statistiškai reikšminga, p-reikšmė 0.01033 < 0.05 - statistiškai reikšminga.
\end{itemize}
...
\begin{itemize}
    \item  Esant aukštam modelio tikslumui, rekomenduojama naudoti homomorfinį šifravimą. Esant mažesniam nei 80\% tikslumui, rekomenduojama naudoti PyTorch neuroninius tinklus.
